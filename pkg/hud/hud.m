...
static void hudEnsureWindow(void) {
	...
	[hudWindow setCollectionBehavior:NSWindowCollectionBehaviorCanJoinAllSpaces | NSWindowCollectionBehaviorStationary |
	...
	hudLabel = [[NSTextField alloc] initWithFrame:NSMakeRect(14, 29, hudWidth - 28, 22)];
	...
	hudSubLabel = [[NSTextField alloc] initWithFrame:NSMakeRect(14, 11, hudWidth - 28, 15)];
...
void hudShow(const char *ctext, const char *csubtitle) {
	...
	dispatch_async(dispatch_get_main_queue(), ^{
	  ...
	  [hudLabel setFrame:(hasSubtitle ? NSMakeRect(14, 29, hudWidth - 28, 22)
		                              : NSMakeRect(14, (hudHeight - 22) / 2.0, hudWidth - 28, 22))];
